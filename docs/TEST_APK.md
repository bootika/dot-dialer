...
```shell
adb install -r app/build/outputs/apk/foss/debug/dot-dialer-58-foss-debug.apk
```

The `58` segment is the current version code and changes when the project version is incremented.
